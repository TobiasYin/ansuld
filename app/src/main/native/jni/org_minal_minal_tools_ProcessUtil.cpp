...
#include "org_minal_minal_tools_ProcessUtil.h"
#include "../cpp/create_sub_process.h"
#include <android/log.h>
#include <wait.h>
#include "unistd.h"

extern "C" JNIEXPORT jint JNICALL Java_org_minal_minal_tools_ProcessUtil_createSubProcess
...
extern "C" jint Java_org_minal_minal_tools_ProcessUtil_waitPid(JNIEnv *env, jobject thiz, jint pid) {
    int status;
...
extern "C" jint Java_org_minal_minal_tools_ProcessUtil_closeFd(JNIEnv *env, jobject thiz, jint fd) {
    close(fd);
    return 0;
}
...
Java_org_minal_minal_tools_ProcessUtil_createProcess(JNIEnv *env, jobject thiz, jobject args,
    ...
    envID = env->GetFieldID(clazz, "env", "[Lorg/minal/minal/tools/EnvItem;");
